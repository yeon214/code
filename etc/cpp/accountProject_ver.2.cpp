...
private:
	...
	int originalMoney, accountNumber, transferFee; //잔액, 계좌번호, 이체 수수료
...
int main(void){
	...
	double interestRate; //이자율
	cout << "첫번째 통장을 먼저 개설하겠습니다. 정보를 입력해주세요.\n";
	cout << "이름 : ", cin >> accountName;
	cout << "계좌번호 : ", cin >> accountNumber;
	cout << "잔액 : ", cin >> originalMoney;
	cout << "이체 수수료 : ", cin >> transferFee;
	cout << "이자율 : ", cin >> interestRate;
	Account_ customer_constructor(accountName, accountNumber, originalMoney, transferFee, interestRate);
	cout << "10,000원 이상 예치 시, 단리 방식으로 이자가 적용됩니다." << "\n\n";

	cout << "두번째 통장을 먼저 개설하겠습니다. 정보를 입력해주세요.\n";
	cout << "이름 : ", cin >> accountName;
	cout << "계좌번호 : ", cin >> accountNumber;
	cout << "잔액 : ", cin >> originalMoney;
	cout << "이체 수수료 : ", cin >> transferFee;
